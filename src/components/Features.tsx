...
const FaRocket = dynamic(() => import('react-icons/fa').then(mod => mod.FaRocket), { ssr: false });
          ...
          {cards.map((card, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg flex flex-col md:flex-row items-center gap-6 cursor-pointer"
              >
