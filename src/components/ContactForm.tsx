    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <motion.form
                ...
                className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-lg flex flex-col gap-6">
                <input
                    type="text"
                ...
                <textarea
                    ...
                    rows={6}
                    className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
            ...
            <motion.div
                ...
                <p className="text-gray-600 dark:text-gray-400">
                    We’re here to help you 24/7. Fill out the form, and our team
