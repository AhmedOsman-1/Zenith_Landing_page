  ...
  const faqs = [
    {
      ...
      answer:
        "Click the 'Get for Free' button on the top-right, fill in your details, and start using our SaaS platform instantly.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Absolutely! You can explore all features free for 14 days with no credit card required.",
    },
    {
      question: "How do I contact support?",
      answer:
        "Use the form below, or reach out via email or phone. We respond within 24 hours.",
    },
  ];
